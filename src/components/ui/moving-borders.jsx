...
export function Button({
  ...
  return (
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="32%" ry="32%">
          <div
            className={cn(
              "h-[32px] w-32 opacity-[0.8] bg-[radial-gradient(var(--sky-500)_40%,transparent_60%)]",
              borderClassName
            )}
          />
        </MovingBorder>
...
export const MovingBorder = ({
  ...
  useAnimationFrame((time) => {
    ...
    if (length) {
      ...
      // Reverse the motion by subtracting from `length`.
