  ...
  return (
    <div className='bg-white7 rounded-md p-4'>
      ...
      <div className='rounded-sm mt-4'>
        <div onClick={handleNavigateToProfile} className='flex justify-between items-center bg-white4 p-3 rounded-t-md'>
        ...
        <div onClick={handleParticipateInBounties} className='flex justify-between items-center bg-white/10 p-3 border-t border-b border-dashed border-white12'>
          <div className='text-white64 text-[13px] font-semibold font-inter flex items-center gap-1'>
        ...
        <div className='flex justify-between items-center bg-white/10 p-3 rounded-b-md'>
          <div className='text-white64 text-[13px] font-semibold font-inter flex items-center gap-1'>
